        ...
        {editing ? (
          ...
          <div className="flex items-start gap-3">
            <button
              ...
              className="-mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-lg text-4xl leading-none text-muted transition hover:bg-surface hover:text-ink"
              title={open ? "ย่อ" : "ขยาย"}
              aria-expanded={open}
            >
              {open ? "▾" : "▸"}
